...
# Replace all prior descriptive witness values with a witness of the actual
# rebuilt part.  Material found inside the nominal Ø4.40 root bore can only be
# the inward-projecting helical thread tooth.
anchor = "failures = []\n"
if anchor not in s:
